 ...
 *
 */
export declare function submit_tasks(access_token: string | null, endpoint_uuid: string, function_uuid: string, args: string, kwargs: string): Promise<TaskSubmission>;
/**
